...
public class DeviceGroupQueryTest {
    ...
    public void testReturnTemperatureValueForWorkingDevices() {
        ...
        ActorRef queryActor =
                              system.actorOf(DeviceGroupQuery.props(actorToDeviceId, 1L, requester.getRef(),
    ...
    public void testReturnDeviceTimedOutIfDeviceDoesNotAnswerInTime() {
        ...
        DeviceGroup.RespondAllTemperatures response =
                                                      requester.expectMsgClass(FiniteDuration.create(5, TimeUnit.SECONDS),
    ...
    protected void assertEqualTemperatures(Map<String, DeviceGroup.TemperatureReading> expectedTemperatures, Map<String, DeviceGroup.TemperatureReading> receivedTemperatures) {
        assertEquals(expectedTemperatures, receivedTemperatures);
    }
